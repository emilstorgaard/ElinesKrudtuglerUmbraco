...
WORKDIR /src
COPY ["ElinesKrudtuglerUmbraco.csproj", "Directory.Packages.props", "./"]
...
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "ElinesKrudtuglerUmbraco.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
